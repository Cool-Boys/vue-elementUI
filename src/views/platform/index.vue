<template>
  <div class="app-container">
    <div class="filter-container">
      <el-input v-model="listQuery.sname" placeholder="平台名称" style="width: 200px;" class="filter-item" @keyup.enter.native="handleFilter" />
...
import { findByWhere, insert, update, deleteData } from '@/api/platform'
